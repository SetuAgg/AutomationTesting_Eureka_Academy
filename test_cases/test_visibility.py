...
'''
    def test_visibility(self,setup):
        ...
        if feedback_btn.is_displayed():
            ...
            allure.attach(message25, name="Feedback_Button_Section_Visibility", attachment_type=allure.attachment_type.TEXT)
        else:
            allure.attach(self.driver.get_screenshot_as_png(), name='test_visibility', attachment_type=allure.attachment_type.PNG)
            message26 = "Feedback Button Section is not visible and test-case failed.."
            allure.attach(message26, name="Feedback_Button_Section_Visibility", attachment_type=allure.attachment_type.TEXT)
            assert False
        time.sleep(2)
